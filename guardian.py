...
# ========================================================
# STUB DEPENDENCIES (for standalone operation)
# ========================================================
...
class BudgetContext:
    ...
    def __exit__(self, *args):
        ...
        # Budget checking would happen here
...
def wrap_file_write(task_id: str, lane: str, file_path: str, content: str, write_fn: Callable):
...
def wrap_file_delete(task_id: str, lane: str, file_path: str, delete_fn: Callable):
...
def wrap_json_write(task_id: str, lane: str, file_path: str, data: dict, write_fn: Callable):
